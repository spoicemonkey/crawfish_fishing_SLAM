...
# Custom message
# from engr4200_basics_src_lib.msg import IncrementalOdometry2D

# Custom libraries
from engr4200_basics_src_lib.functions import publish_lines, get_map, \
...
class LocalizationNode(object):
    ...
    def iterate(self):
        ...
        if self.new_odom:
            ...
            self.ekf.predict(self.uk.copy(), self.lines.copy())
            self.new_odom = False
            self.pub = True
